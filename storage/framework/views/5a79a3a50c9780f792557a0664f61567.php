                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0"><?php echo e($siswa->count()); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0"><?php echo e($siswa->where('kelas', 'X')->count()); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0"><?php echo e($siswa->where('kelas', 'XI')->count()); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0"><?php echo e($siswa->where('kelas', 'XII')->count()); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="row align-items-center">
                ...
                <div class="col-md-3">
                    <div class="text-end">
                        <small class="text-muted">Total: <?php echo e($siswa->count()); ?> siswa</small>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <span class="badge bg-light text-dark"><?php echo e($s->nis); ?></span>
                                </td>
                                <td class="align-middle">
                                    <div class="d-flex align-items-center">
                                ...
                                <td class="align-middle">
                                    <span class="badge bg-info"><?php echo e($s->kelas); ?></span>
                                </td>
                                <td class="align-middle">
                                    <div class="btn-group" role="group">
                                        <a href="<?php echo e(route('siswa.show', $s->id_siswa)); ?>" class="btn btn-sm btn-outline-primary">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if(auth()->user()->role === 'admin'): ?>
                                            <a href="<?php echo e(route('siswa.edit', $s->id_siswa)); ?>" class="btn btn-sm btn-outline-warning">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-sm btn-outline-danger" onclick="confirmDelete(<?php echo e($s->id_siswa); ?>)">
                ...
                <div class="card-footer bg-white border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-muted">
                            Menampilkan <?php echo e($siswa->firstItem()); ?> - <?php echo e($siswa->lastItem()); ?> dari <?php echo e($siswa->total()); ?> data
                        </div>
                        <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\website-sekolah\resources\views/siswa/index.blade.php ENDPATH**/ ?>